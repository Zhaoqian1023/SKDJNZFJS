			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div class="graph-visual tables-main">
						...
						<div class="graph">
							<!--startprint1-->
							<h3 class="inner-tittle two" style="text-align:center;">济南校区机关作风建设民主评议测评汇总表（${summaryList.get(0).type }&nbsp;票）
							</h3>
							...
							<div class="tables">
								...
								<table class="table table-bordered" width="100%">
									<thead>
										<tr>
											<th width="25%" style="text-align:center">机关部门</th>
									...
									<tbody style="text-align:center">
										<c:forEach items="${summaryList }" var="att"
											varStatus="varstatus">
											<c:choose>
											<c:when test="${varstatus.count == 1 || varstatus.count == 9}">  
												<tr class="active">
													<th scope="row" style="text-align:center">${att.dept }</th>
													<td>${att.gZzz }</td>
													<td>${att.gZcx }</td>
													<td>${att.zCnl }</td>
													<td>${att.xTgt }</td>
											...
											<c:when test="${varstatus.count == 3 ||varstatus.count == 11 }">  
												<tr class="success">
													<th scope="row" style="text-align:center">${att.dept }</th>
													<td>${att.gZzz }</td>
													<td>${att.gZcx }</td>
											...
											<c:when test="${varstatus.count == 5 || varstatus.count == 13 }">  
												<tr class="info">
													<th scope="row" style="text-align:center">${att.dept }</th>
													<td>${att.gZzz }</td>
													<td>${att.gZcx }</td>
											...
											<c:when test="${varstatus.count == 7 || varstatus.count == 15 }">  
												<tr class="warning">
													<th scope="row" style="text-align:center">${att.dept }</th>
													<td>${att.gZzz }</td>
													<td>${att.gZcx }</td>
