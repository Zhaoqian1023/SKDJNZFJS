							...
							<div class="outter-wp">
								  ...
								  <!--//sub-heard-part-->
									<div class="graph-visual tables-main">
													...
													<h3 class="inner-tittle two" style="text-align:center;" >济南校区机关作风建设民主评议测评表（B&nbsp;票） </h3>
														  <div class="graph">
															<div class="tables">
															<form  name="formName" id="formName" action="" method="post">
                                                                ...
                                                                <thead >
                                                                	<tr >
                                                                    	<th width="25%"  style="text-align:center;padding: 15px !important; ">机关部门<input type="text" name="type" value="B" hidden="hidden"></th>
                                                    ...
                                                    <div class="buttons-ui">
																<a class="btn red" href="importtableB.jsp">&nbsp;&nbsp;重&nbsp;置&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
